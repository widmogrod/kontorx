<?php
class Promotor_View_Helper_CatalogService extends Zend_View_Helper_Abstract {

	public function catalogService($page = null, $rowCount = null) {
		if (is_integer($page)) {
			$this->setPage($page);
		}
	...
	/**
	 * @return Promotor_View_Helper_CatalogService
	 */
